    ...
    navbar = dbc.NavbarSimple(
        children=[
            dbc.NavItem(
                dbc.NavLink(
                    [
                        html.I(className="fa-solid fa-car"),  # Font Awesome Icon
                        " "  # Text beside icon
                    ],
            ...
            dbc.NavItem(
                dbc.NavLink(
                    [
                        html.I(className="fa-solid fa-plane"),  # Font Awesome Icon
                        " "  # Text beside icon
                    ],
            ...
            dbc.NavItem(
                dbc.NavLink(
                    [
                        html.I(className="fa-solid fa-rocket"),  # Font Awesome Icon
                        " "  # Text beside icon
                    ],
