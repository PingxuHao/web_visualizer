def fig1_func (a11 = 1, a12 = -1, a21 = 1, a22 = 2):    
    ...
    if not linear:       
        l1 = add_rotation_frame(A1,20,square1,X1,Y1,unit_v,total_num_frames)
        total_num_frames += 20
        frame1 = l1[4]

        l2 = add_frame(A2,20,l1[0],l1[1],l1[2],l1[3],total_num_frames)
        total_num_frames += 20
        frame2 = l2[4]

        l3 = add_rotation_frame(A3,20,l2[0],l2[1],l2[2],l2[3],total_num_frames)
        total_num_frames += 20
        frame3 = l3[4]
    else:
        l1 = add_frame(A1,20,square1,X1,Y1,unit_v,total_num_frames)
        total_num_frames += 20
        frame1 = l1[4]
